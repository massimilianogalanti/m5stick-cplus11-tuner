...
void mic_record_task(void *arg) {
  ...
  while (1) {
    ...
    if (found == true) {
      ...
      //M5.Lcd.fillEllipse(SCREEN_WIDTH / 2 + oldy[0] * 10, SCREEN_HEIGHT / 4 * 3, 10, 10, color);
      //M5.Lcd.println(peakv);
    }
